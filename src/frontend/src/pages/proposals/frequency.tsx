...
import {FormationOfIncreasingFrequencyOfVisits} from "../../api/suggestion-query";
import {CustomField} from "../../components/customField";
import {Field, FieldType} from "../../components/form";
import {
  Suggestion, SuggestionQueriesFormationOfAverageTicketGrowthArgs, SuggestionQuery
...
export function Frequency() {
  ...
  const columns = [
    ...
    {key: 'numberTransactions', header: 'Number of transactions'},
  ...
  const {loading, error, data} =
    useQuery<SuggestionQuery, SuggestionQueriesFormationOfAverageTicketGrowthArgs>(
        FormationOfIncreasingFrequencyOfVisits,
      {
        variables: {
  ...
  const rows: Maybe<Suggestion>[] = data?.suggestion?.formationOfIncreasingFrequencyOfVisits ?
    data.suggestion.formationOfIncreasingFrequencyOfVisits : [];
